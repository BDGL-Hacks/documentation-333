...
\subsubsection{Xcode Interface Builder}
...
We had not even considered the possibility of a significant language update when we decided on Swift. 
...
As our code base grew, it grew more liable to a change in Swift.
